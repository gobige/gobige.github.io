...
### 设计模式的认知理解
大多数设计模式从结构上看起来都差不多，争论时哪一种设计模式没有那么重要，设计模式更应该关注这个模式意图是什么，里面的关键角色是什么，常见的关键词，解决的哪类问题？更多的将业务上的理解转化为系统的理解
...
<span id = "singleTon"><b>单例模式</b></span>
...
<span id = "prototype"><b>原型模式</b></span>
...
<span id = "pattern"><b>适配器模式</b></span>
...
<span id = "composite"><b>组合模式</b></span>
...
<span id = "decorate"><b>装饰器模式</b></span>
...
<span id = "flyweight"><b>享元模式</b></span>
...
<span id = "responsible"><b>责任链模式</b></span>
...
<span id = "explain"><b>解释器模式</b></span>
...
<span id = "iterator"><b>迭代器模式</b></span>
...
<span id = "memento"><b>备忘录模式</b></span>
...
<span id = "observer"><b>观察者模式</b></span>
...
<span id = "strategy"><b>策略模式</b></span>
...
<span id = "nullObj"><b>空对象模式</b></span>
...
<span id = "template"><b>模板模式</b></span>
