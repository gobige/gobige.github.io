...
![请输入图片地址](http://muyibeyond.cn/img/2018-03-19-jvm/10.png)
![请输入图片地址](http://muyibeyond.cn/img/2018-03-19-jvm/11.png)

**jps：jvm进程状况工具**
- 列出正在运行的虚拟机进程，并显示虚拟机执行主类

jps指令常见选项
![请输入图片地址](http://muyibeyond.cn/img/2018-03-19-jvm/12.png)

**jstat：虚拟机统计信息监视工具**
- 用于监视jvm各种运行专题信息，显示类装载，内存，垃圾回收，jit编译等运行数据

jstat指令常见选项
![请输入图片地址](http://muyibeyond.cn/img/2018-03-19-jvm/13.png)
...
![请输入图片地址](http://muyibeyond.cn/img/2018-03-19-jvm/14.png)
...
![请输入图片地址](http://muyibeyond.cn/img/2018-03-19-jvm/15.png)

除了上述命令行工具，jdk还提供了两个强大的外部可视化工具JConsole，VisualVM

**JConsole：java监视和管理控制台**

![请输入图片地址](http://muyibeyond.cn/img/2018-03-19-jvm/16.png)
