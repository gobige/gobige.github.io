...
![此处输入图片的描述](http://yatesblog.oss-cn-shenzhen.aliyuncs.com/img/computer-system-Perspective/56.png)

kafka zero copy流程
![此处输入图片的描述](http://yatesblog.oss-cn-shenzhen.aliyuncs.com/img/computer-system-Perspective/57.png)


## 硬件错误

**单比特翻转**
因为内存制造质量造成的漏电还是外部射线，单个bit位从0变成1或从1变成0

**奇偶校验码**
把内存N位比特为一组，用额外一位去记录1的奇数还是偶数

**ECC内存**
在内存出现错误的时候，能够自己纠正过滤。通过**纠错码和纠删码**技术

**海明码**
纠错码需要更多冗余信息，才能知道内存发生错误时，哪里数据错了，甚至把数据改对
